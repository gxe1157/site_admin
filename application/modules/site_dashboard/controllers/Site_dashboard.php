...
function submit_login()
{
    ...
    if ($submit=="Submit") {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $query = $this->cntlr_name->get_with_double_condition($col1, $value1, $col2, $value2);
            ...
            $this->cntlr_name->_update($user_id, $data);
...
function activate($security_code=null)
{
    ...
    $results_set = $this->cntlr_name->get_view_data_custom('security_code', $security_code,
     'user_login', null);
...
function forgot_password()
{
    ...
    if ($submit=="Send My Password") {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $results_set = $this->cntlr_name->get_view_data_custom(
...
function change_password()
{
    ...
    $results_set = $this->cntlr_name->get_view_data_custom('id', $userid, 'user_login', null)->result();
    ...
    if ($this->form_validation->run() == TRUE) {
        ...
        $this->cntlr_name->_update($userid, $data);
